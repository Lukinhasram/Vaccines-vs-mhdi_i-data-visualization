...
fig = px.scatter(
    ...
    title=f'Cobertura Vacinal vs MHDI_I — {ano_selecionado}<br>{subtitulo}', # Título do gráfico, incluindo ano e subtítulo com correlação
...
st.markdown("<h3 style='font-size: 20px;'>Variações Regionais na Cobertura Vacinal</h3><br>"
"<p style='font-size: 18px;'>Disparidades geográficas significativas na cobertura vacinal existem em todo o Brasil, com taxas mais baixas frequentemente observadas nas regiões Norte e Nordeste em comparação com o Sul e Sudeste. Essas disparidades regionais frequentemente se correlacionam com variações no desenvolvimento socioeconômico e no acesso à infraestrutura de saúde. Essas disparidades regionais persistentes provavelmente contribuem para a relação não linear, pois áreas com IDH mais baixo podem consistentemente exibir menor cobertura vacinal devido a barreiras sistêmicas. A distribuição desigual de recursos, infraestrutura e profissionais de saúde em todo o Brasil significa que, mesmo com melhorias no IDH em nível nacional, certas regiões podem continuar a ficar para trás na cobertura vacinal, levando a uma relação geral complexa.</p>"
"<h3 style='font-size: 20px;'>Correlação entre IDH, Status Socioeconômico e Vacinação</h3><br>"
"<p style='font-size: 18px;'>Municípios com IDH mais baixo e anos esperados de escolaridade consistentemente apresentam taxas de cobertura vacinal mais baixas. Grupos socioeconômicos mais baixos frequentemente apresentam as maiores taxas de não vacinação. A associação entre IDH e cobertura vacinal pode ser modificada por fatores como a cobertura da atenção primária à saúde. A descoberta consistente de taxas de vacinação mais baixas em áreas com IDH mais baixo e entre grupos socioeconômicos mais baixos sugere fortemente uma correlação positiva entre desenvolvimento humano e cobertura vacinal, mas a modificação por outros fatores indica uma relação não linear onde o desenvolvimento socioeconômico sozinho não garante alta cobertura. Embora um IDH mais alto geralmente implique melhor acesso à educação, saúde e recursos, o que deve facilitar a vacinação, a influência de fatores como a eficácia da atenção primária e contextos locais específicos pode criar variações nessa relação.</p>"
"<h3 style='font-size: 20px;'>Desafios Enfrentados por Populações Vulneráveis</h3><br>"
"<p style='font-size: 18px;'>Alcançar populações vulneráveis, como comunidades indígenas, aquelas em áreas remotas e famílias de baixa renda, requer estratégias específicas que abordem suas barreiras únicas de acesso. Fatores como distância das unidades de saúde, falta de transporte e restrições financeiras são barreiras significativas. Os desafios específicos enfrentados pelas populações vulneráveis provavelmente contribuem para a não linearidade, criando focos de menor cobertura vacinal mesmo em regiões com IDH médio relativamente mais alto, pois essas populações podem ser desproporcionalmente afetadas por barreiras de acesso. Embora uma região possa apresentar melhorias gerais no IDH, comunidades marginalizadas dentro dessa região ainda podem enfrentar obstáculos significativos para acessar serviços de saúde como a vacinação, levando a uma relação mais complexa e não uniforme entre desenvolvimento humano e cobertura vacinal.</p>"
"<br>"
"<h3 style='font-size: 20px;'>Análise Temporal da Correlação e P-valor:</h3>"
"<p style='font-size: 18px;'><strong>1996-1999:</strong> Há uma tendência de aumento na correlação positiva entre a Cobertura Vacinal Média e o MHDI_I, com o P-valor diminuindo e a Correlação de Pearson aumentando.</p>"
...
"<p style='font-size: 18px;'><strong>2006-2011:</strong> Observa-se uma tendência de correlação negativa, sugerindo que a Cobertura Vacinal Média diminui à medida que o MHDI_I aumenta, embora a significância estatística varie.</p>"
"<p style='font-size: 18px;'><strong>2016-2021:</strong> A correlação torna-se positiva novamente, indicando uma tendência de aumento na Cobertura Vacinal Média com o aumento do MHDI_I, com alguns anos mostrando significância estatística (2016, 2020 e 2021).</p>"
"<br>"
"<h3 style='font-size: 20px;'>Interpretação das Transições Suaves nos Gráficos:</h3>"
"<p style='font-size: 18px;'>As transições suaves entre os gráficos e suas linhas de correlação ao longo dos anos fornecem algumas informações importantes sobre a relação entre a Cobertura Vacinal Média e o MHDI_I:</p>"
...
"<p style='font-size: 18px;'><strong>Possíveis Fatores Causais:</strong> A gradualidade das mudanças pode sugerir que fatores causais que afetam a Cobertura Vacinal Média e o MHDI_I também evoluem lentamente. Isso pode incluir mudanças demográficas, melhorias na educação, expansão dos serviços de saúde, ou transformações nas políticas de saúde pública.</p>"
